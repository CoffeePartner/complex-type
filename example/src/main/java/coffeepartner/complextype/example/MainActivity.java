...
import coffeepartner.complextype.example.delegation.DelegationActivity;
...
public class MainActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    findViewById(R.id.btn_delegation).setOnClickListener(l ->
      AbstractRvActivity.jumpTo(((TextView) l).getText().toString(), MainActivity.this, DelegationActivity.class));
  }
}
